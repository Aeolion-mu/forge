 ...
 */
export function makeOutlineTool(workdir: string, allowReadOutside = false): AgentHarnessTool<object | undefined, typeof outlineSchema, { path: string; symbols: number; supported: boolean }> {
  return {
    name: "outline",
    label: "代码大纲",
    description:
