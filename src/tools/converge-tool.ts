...
export function makeConvergeTools(onSubmit: (justification: string) => void): AgentHarnessTool<object | undefined>[] {
  const submit: AgentHarnessTool<object | undefined, typeof schema, { submitted: true }> = {
  ...
  return [submit] as unknown as AgentHarnessTool<object | undefined>[];
}
